    ...
    return (
        ...
        <MenuProvider>
            ...
            {/* <View style={{ width: "90%", justifyContent: "center", alignContent: "center",marginTop:20 }}>
              ...
              <View style={{ width: "100%", flexDirection: "row", borderColor: "#DBDBDB", paddingBottom:10,backgroundColor:"#708efc",paddingTop:30 }}>
                <TouchableOpacity style={{ width: "10%", marginHorizontal: 10,marginTop:10 }}onPress={() =>this.props.navigation.navigate('profile')}>
...
<Menu >
          ...
          <Text style={{color: '#003cff',fontSize:17,fontWeight:"bold"}}>Update Details</Text>
              ...
              <ScrollView style={{backgroundColor:"#000",top:-18,borderTopLeftRadius:30}}>
<View >
...
<View style={{ flexDirection: "row-reverse", marginTop: 10,paddingHorizontal:20}}>
        ...
        <View style={{width:"100%", flexDirection: "row",marginBottom: Constants.platform.ios?this.state.keyboardHeight:0}}>
             <View style={{ width:"88%",backgroundColor:"#FFf", borderRadius: 50,flexDirection:"row",marginLeft:8,paddingVertical:8,marginBottom:12}}>
             <View style={{width:"80%"}}>
