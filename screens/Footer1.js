...
export default class Footer1 extends Component {
  ...
  render() {
    return (
      <View style={{ width: "100%", position: "absolute", bottom: 90, zIndex: 0, alignItems: "center", alignContent: "center" }}>
        <View style={{ width: "80%", flexDirection: "row", paddingHorizontal: 5, borderBottomLeftRadius: 15, borderTopRightRadius: 15 }}>
          <View style={styles.icon}>
            <TouchableOpacity style={{ width: "100%", alignItems: "center", backgroundColor: this.props.title == "profile" ? "#FAF1EF" : "", borderBottomLeftRadius: 15 }} onPress={() => this.props.navigation.navigate('profile')} >

              <View style={{ width: "100%", paddingTop: 5, alignItems: "center" }}>
                <View>
                  <Octicons name="person" size={18} color={this.props.title == "profile" ? "#E4717D" : "#B1B1B1"} />
                </View>
          ...
          <View style={styles.icon}>
            <TouchableOpacity style={{ width: "100%", alignItems: "center", backgroundColor: this.props.title == "Messages" ? "#FAF1EF" : "" }} onPress={() => this.props.navigation.navigate('Messages')}>
              <View style={{ width: "95%", paddingTop: 5, alignItems: "center" }}>
                <View>

                  <Entypo name="chat" size={18} color={this.props.title == "Messages" ? "#E4717D" : "#B1B1B1"} />
                </View>
          ...
          <View style={styles.icon}>
            <TouchableOpacity style={{ width: "100%", alignItems: "center", backgroundColor: this.props.title == "Chat" ? "#FAF1EF" : "#fff", borderTopRightRadius: 15 }} onPress={() => this.props.navigation.navigate('Chat')}>
              ...
              <View style={{ width: "95%", paddingTop: 5, alignItems: "center" }}>
                <View >
                  <MaterialIcons name="chat-bubble-outline" size={18} color={this.props.title == "Chat" ? "#E4717D" : "#B1B1B1"} />
                </View>
